...
<body>
	...
	if (isset($_POST['submit'])) {
		...
		if($success==true) {
			echo "<h1>Bạn đã đặt phòng!</h1>";
			echo "<h2>Chúng tôi đã nhận được yêu cầu đặt chỗ của bạn và chúng tôi rất mong sớm được gặp bạn.</h2>";
			echo "<h2>Số đặt chỗ của bạn là: <span class='big'>" .$ref. "</span></h2>";
			echo "<h2>Nếu bạn muốn quay lại trang chủ, <a href='index.php'>click here</a>.</h2>";
		} else if($norooms==false) {
			echo "<h1>Chúng tôi xin lỗi!</h1>";
			echo "<h2>chúng tôi phát hiện ra rằng chúng tôi không còn phòng chống nữa.</h2>";
			echo "<h2 style='font-size: 22px'>vui lòng liên hệ lại với chúng tôi để giải quyết vấn đề này.</h2>";
			echo "<h2>Nếu bạn muốn quay lại trang chủ, <a href='index.php'>click here</a>.</h2>";
		} else {
