...
<style>
  .image {
    width: 100%;
    height: 580px;
    background: url("img/hotel3c.jpg");
...
<body>
  ...
  <div class="nav">
    ...
    <a class="about" href="book.php">ABOUT US</a>
    <a class="about" href="#">CONTACT</a>
  </div>

  <div class="back_wall"><h1 class="choose">Chọn Phòng</h1></div>


  <div class="available_choose">
    <form method="POST" action="">
      <div class="in_choose">
        <label style="color:#FFC94D">Ngày nhận phòng: </label><br/><br/>
        <b style="font-size:32px"><?php echo "".$day_in.", ".$date_in."."; ?></b>
      </div>
      <div class="out_choose">
        <label style="color:#FFC94D">Ngày trả phòng: </label><br/><br/>
	...
	<h4 class="choose_button">Chọn phòng</h4>
	<div class="choose_buttons">
  	<button class="click-button" id="myBtn1">Phòng đơn</button>
  	<button class="click-button" id="myBtn2">Phòng đôi</button>
		<button class="click-button" id="myBtn3">Phòng sang trọng</button>
		<button class="click-button" id="myBtn4">Phòng gia đình</button>
		<button class="click-button" id="myBtn5">Phòng thượng hạng</button>
	</div>
    ...
    <div class="modal-content">
      ...
      <form method="POST" action="card.php">
        <div class="room_final">
          <br/><label for="name">Họ và tên</label><br/>
        ...
        <div class="form-group">
          <label for="date_in">Ngày nhận phòng</label><br/>
          <input type="text" name="date_in" onfocus="(this.type = 'date')" class="input_field noclick" value="<?php echo "".$date_in."."; ?>" readonly><br/><br/>
        </div>
        <div class="form-group">
          <label for="date_out">Ngày trả phòng</label><br/>
					<input type="text" name="date_out" onfocus="(this.type = 'date')" class="input_field noclick" value="<?php echo "".$date_out."."; ?>" readonly><br/><br/>
        </div>
        <p>Ngày lưu trú: <b><?php echo $calc_days ?></b></p>
        <input type="submit" class="submit" name="submit" value="Lưu">
				<button class="submit cancel" id="cancel">Thoát</button>
      </form>
    </div>
  </div>

	<footer>
		<p style="font-family: 'Dancing Script'">Luxyry Hotel</p>
	</footer>
